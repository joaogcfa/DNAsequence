...
- [`Relatorio_Final.ipynb`](https://github.com/joaogcfa/DNAsequence/blob/main/Relatorio_Final.ipynb): This is the principal notebook containing the final report and demonstration of the methodology and results. **Recommended as the main entry point for analysis and experiments.**
